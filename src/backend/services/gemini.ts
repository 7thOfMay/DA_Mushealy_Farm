...
function buildSystemInstruction() {
  return [
    ...
    "Context co the gom ca lich su xa hon cua khu vuon trong phan history, bao gom tong quan all-time, cua so 24h/7d/30d, recentSamples va dailyRollups.",
    ...
    "Khi nguoi dung hoi ve xu huong cu, giai doan xa, bien dong nhieu ngay, hay uu tien phan history thay vi chi nhin latestSensors.",
